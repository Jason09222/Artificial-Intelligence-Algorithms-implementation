...
class Qlearning(Agent):
    ...
    #TODO Create the action selection function that uses Q-learning with random number from the file 
    ...
    def do_step(self, S, act, logfile=None):
        ...
        #TODO replace code in lines 41 - 50 and use your defined action selection method to determine the action instead.
